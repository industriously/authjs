 ...
 */
export type IIdToken<Scope extends "email" | "profile" | "" = ""> =
  IIdTokenDefault &
    ("email" extends Scope ? IIdTokenEmailClaim : object) &
    ("profile" extends Scope ? IIdTokenNameClaim : object);
